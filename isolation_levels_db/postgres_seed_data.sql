-- Sample Seed Data for PostgreSQL Instagram Database
-- Run this after creating the schema with postgres_schema.sql
...
(1, 'photo', 'https://example.com/stories/john_story1.jpg', NULL, 89, NOW() + INTERVAL '24 hours'),
(2, 'video', 'https://example.com/stories/jane_story1.mp4', 'https://example.com/stories/jane_story1_thumb.jpg', 234, NOW() + INTERVAL '24 hours'),
(3, 'photo', 'https://example.com/stories/mike_story1.jpg', NULL, 156, NOW() + INTERVAL '24 hours'),
(4, 'photo', 'https://example.com/stories/sarah_story1.jpg', NULL, 67, NOW() + INTERVAL '24 hours');
